...
namespace SFA.DAS.Notifications.MessageHandlers2.DependencyResolution
{
    public class DefaultRegistry : Registry
    {
        public DefaultRegistry()
        {
            ...
            For<ILoggerFactory>().Use(() => new LoggerFactory().AddApplicationInsights(CloudConfigurationManager.GetSetting("APPINSIGHTS_INSTRUMENTATIONKEY", null).AddNLog()).Singleton();
